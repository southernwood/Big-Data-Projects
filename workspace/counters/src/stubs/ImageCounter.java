  ...
  public int run(String[] args) throws Exception {
    ...
    if (success) {
       ...
       */
    	...
    	System.out.println("JPG = " + job.getCounters().findCounter("ImageCounter", "jpg").getValue());
    	System.out.println("GIF = " + job.getCounters().findCounter("ImageCounter", "gif").getValue());
    	System.out.println("Other = " + job.getCounters().findCounter("ImageCounter", "other").getValue());
      return 0;
    } else
      return 1;
